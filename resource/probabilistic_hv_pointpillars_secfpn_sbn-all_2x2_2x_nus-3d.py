...
model = dict(
    ...
    pts_bbox_head=dict(
        type='ProbabilisticAnchor3DHead',
        num_classes=10,
        in_channels=384,
        feat_channels=384,
        ...
        loss_cls=dict(
            ...
            loss_weight=1.0),
        loss_bbox=dict(
            type='MyLoss', beta=0.1111111111111111, loss_weight=0.1),
        loss_dir=dict(
...
optimizer = dict(type='AdamW', lr=0.00025, weight_decay=0.01)
...
log_level = 'INFO'
work_dir = './work_dirs/probabilistic_hv_pointpillars_secfpn_sbn-all_4x8_2x_nus-3d'
load_from = None
resume_from = None
workflow = [('train', 1)]
gpu_ids = range(0, 2)
